                                ...
                                <div class="card card-event">
                                    <div class="card-block">
                                        <div class="row align-items-center justify-content-center">
                                            <div class="col">
                                                <h5 class="m-0">{{$driver->full_name}}</h5>
                                                <sub class="text-muted f-14">{{$driver->email}}</sub><br>
                                                <sub class="text-muted f-14">{{$driver->telefono}}</sub><br>
                                            </div>
                                        </div>
                                        <h6 class="text-muted mt-4 mb-0">
                                            <a href="{{route('driver.edit',$driver->id)}}" class="btn btn-primary btn-rounded btn-sm f-12">Editar</a> 
                                            <a href="{{route('driver.destroy',$driver->id)}}" class="btn btn-danger btn-rounded btn-sm f-12">Dar de baja</a> 
                                        </h6>
                                        <i class="fas fa-car text-c-purple f-50"></i>
                                    </div>
                                </div>
                                <div class="card">
