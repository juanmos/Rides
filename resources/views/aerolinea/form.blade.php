    ...
    <div class="pcoded-wrapper">
        <div class="pcoded-content">
            <div class="pcoded-inner-content">
                ...
                <!-- [ breadcrumb ] end -->
                <form action="{{($aerolinea!=null)?route('admin.aerolinea.update',$aerolinea->id):route('admin.aerolinea.store')}}" method="POST">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12 ">
                                                ...
                                                <input type="text" value="@if($aerolinea!=null){{$aerolinea->aerolinea}}@else{{old('aerolinea')}}@endif" name="aerolinea" class="form-control @error('aerolinea') is-invalid @enderror" aria-describedby="emailHelp" placeholder="Numero de aerolinea">
                                                @error('aerolinea')
